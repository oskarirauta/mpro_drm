 ...
 *
 * Maps the screen_id (and optionally version) returned by the device's
 * probe queries to a model_info entry containing dimensions, margin,
 * native rotation and touch calibration flags.
 */
...
/*
 * Suurin osa MPro-malleista käyttää samaa firmware-orientaatiota:
 * MPro laitteen natiivi orientaatio (0,0) on käyttäjän kannalta
 * ylhäällä-oikealla, joten DRM:lle natiiviksi merkitään
 * ROTATE_180 | REFLECT_X.
 */
...
static const struct mpro_model_info mpro_models[] = {
	...
	{ 0x00000005, "MPRO-5", "MPRO 5\"", 480, 854, 62, 110, 0,
	 DRM_MODE_ROTATE_180 | DRM_MODE_REFLECT_X, true, false, false },
	/* Same screen_id, differentiate by margin */
